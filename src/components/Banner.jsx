  ...
  return (
    <div className="w-full flex justify-center lg:px-[160px] lg:pb-10 pb-0">
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative w-full max-w-7xl  rounded-lg border bg-[#43B6C4] h-[540px] lg:h-[166px] lg:bg-black"
      >
        ...
        >
          {/* <div className="p-4 h-[50px] bg-yellow-500 flex justify-start items-center rounded-full"> */}
          NOWWWWWW!
          {/* </div> */}
        </motion.div>
        ...
        <motion.img
          ...
          viewport={{ once: true }}
          className="absolute bottom-0 left-0 z-[1] h-[255px] w-full object-cover lg:w-[372px] lg:h-auto lg:object-contain"
        />
      </motion.div>
    </div>
  );
